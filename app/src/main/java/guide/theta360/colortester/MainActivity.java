package guide.theta360.colortester;
...
import guide.theta360.colortester.R;

import guide.theta360.colortester.task.TakePictureTask;
    ...
    private class WebServer extends NanoHTTPD {
        ...
        private void updateBracket(Map<String, List<String>> parameters) {
            ...
            if (bracket.equals("13")) {
                ...
                notificationLedHide(LedTarget.LED7);
                notificationLedHide(LedTarget.LED8);
                Log.d("COLOR", "saving parameter 13 brackets");
            }
            if (bracket.equals("14")) {
                notificationLedHide(LedTarget.LED4);
                notificationLedHide(LedTarget.LED5);
                notificationLedHide(LedTarget.LED6);
                notificationLedHide(LedTarget.LED7);
                notificationLedShow(LedTarget.LED8);
                Log.d("COLOR", "LED 8, Disk full");

            }
            if (bracket.equals("15"))  {
